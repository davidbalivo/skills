...
{Regla esperada y estado que prohíbe.}

- Motivo: {razón de negocio, regulación o restricción; indicar si se desconoce}.
- Aplica a: {casos y excepciones relevantes}.
- Implementación: {ancla y comportamiento observado; señalar discrepancias y enlazar su entrada en
